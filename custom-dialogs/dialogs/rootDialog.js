...
class RootDialog extends ComponentDialog {
    ...
    constructor(userState) {
        ...
        const slots = [
            new SlotDetails('fullname', 'fullname'),// fullname and address prompts are handled by individual prompts.
        ...
        this.addDialog(new WaterfallDialog('root', [ // root will be first called on 
